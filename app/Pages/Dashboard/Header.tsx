...
import SearchMd from "../../../assets/Icons/search-md.svg";
          ...
          <div className="h-[6.5rem] w-full  xxl:rounded-b-[1rem] bxl:rounded-b-[1rem] xl:rounded-b-[1rem] sxl:rounded-b-[1rem] lg:rounded-b-[1rem] md:rounded-b-none sm:rounded-none xd:rounded-none dark:bg-[#FCFDFE] bg-[#111213] p-[0%_2%] flex items-center justify-start gap-[1rem] ">
            <div className="2xl:hidden xl:hidden lg:hidden md:flex sm:flex xd:flex w-full justify-between items-center">
              ...
              <div className="flex items-center justify-center gap-3">
				<div className="flex-1 rounded-full dark:bg-[#EFF7F8] bg-[#1D1E20]  2xl:hidden xl:hidden lg:hidden md:inline sm:inline xd:inline">
					<div className="flex px-4">
					  <Image src={SearchMd} alt="Search" />
					  <input type="text" placeholder='Search' className="outline-none pl-4 py-3 bg-transparent text-[#A5A5A6] placeholder:text-[#A5A5A6]" />
					</div>
				</div>
            ...
            <div className="flex-1 rounded-[1rem] dark:bg-[#EFF7F8] bg-[#1D1E20]  2xl:inline xl:inline lg:inline md:hidden sm:hidden xd:hidden">
				<div className="flex px-4">
				  <Image src={SearchMd} alt="Search" />
				  <input type="text" placeholder='Search' className="flex-1 outline-none pl-4 py-4 bg-transparent text-[#A5A5A6] placeholder:text-[#A5A5A6]" />
				</div>
            </div>
