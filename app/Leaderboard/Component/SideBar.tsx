    ...
    >
      <div className="w-auto hover:w-full bg-transparent  flex flex-col text-left items-start h-full justify-between p-[1rem] w-full  ">
        <div className="flex flex-col text-left items-start h-full justify-start w-full">
          <div className="flex flex-col text-left items-center justify-center w-full  p-[1rem]   w-full top-0 !sticky  mb-[1.5rem] ">
            {isSidebarExpanded ? (
            ...
            {isLeaderBoard ? (
              <div className="submenu w-full gap-2 flex flex-col">
                <a
                  ...
                  rel="noreferrer"
                  className={`   h-[52px] flex flex-row justify-start items-center  w-full   gap-[16px]`}
                >
                  <div
                    className={` dark:hover:bg-[#EFF7F8] hover:bg-[rgba(255,255,255,0.06)] font-[700] opacity-[1] !bg-[rgba(255,255,255,0.06)]  dark:!bg-[#EFF7F8] menu-item text-[16px] my-[4px]  w-full h-auto  text-[16px] font-[400] flex flex-row justify-start items-center ${
                      isSidebarExpanded
                        ? "py-[1rem] px-[1.4rem]"
                        : "py-[1.2rem] px-[1.4rem]"
